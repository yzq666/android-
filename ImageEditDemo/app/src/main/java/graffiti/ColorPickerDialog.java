...
public class ColorPickerDialog extends Dialog {
    ...
    private class ColorPickerView extends View {
        ...
        public ColorPickerView(Context context, int height, int width) {
            ...
            mPaint.setStrokeWidth(DensityUtil.dip2px(context, 30));//圆环大小
            ...
            mRectPaint.setStrokeWidth(DensityUtil.dip2px(context, 5));
    ...
    public void show() {
        super.show();
        int height = DensityUtil.dip2px(context, 220);
        int width = DensityUtil.dip2px(context, 180);
